// Разработать «чистую» функцию treeSum, которая получает массив, элементы которого могут быть числами 
// или снова массивами, и так до любого уровня.
...
const sum = treeSum => treeSum.reduce((res, el) => res + (Array.isArray(el) ? sum(el) : el), 0);
